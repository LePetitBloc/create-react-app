# Contributing to Create React DApp's E2E tests
...
These tests are run by **jest** and the environment is `test`, so that it resembles how a **Create React DApp** application is tested.
